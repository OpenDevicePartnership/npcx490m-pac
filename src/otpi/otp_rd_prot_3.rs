#[doc = "Register `OTP_RD_PROT_3` reader"]
pub type R = crate::R<OtpRdProt3Spec>;
#[doc = "Register `OTP_RD_PROT_3` writer"]
pub type W = crate::W<OtpRdProt3Spec>;
...
impl W {
    #[doc = "Bit 0 - Read Protect Block 8*n+0"]
    #[inline(always)]
    pub fn rdp8n_0(&mut self) -> Rdp8n0W<OtpRdProt3Spec> {
        Rdp8n0W::new(self, 0)
    }
    #[doc = "Bit 1 - Read Protect Block 8*n+1"]
    #[inline(always)]
    pub fn rdp8n_1(&mut self) -> Rdp8n1W<OtpRdProt3Spec> {
        Rdp8n1W::new(self, 1)
    }
    #[doc = "Bit 2 - Read Protect Block 8*n+2"]
    #[inline(always)]
    pub fn rdp8n_2(&mut self) -> Rdp8n2W<OtpRdProt3Spec> {
        Rdp8n2W::new(self, 2)
    }
    #[doc = "Bit 3 - Read Protect Block 8*n+3"]
    #[inline(always)]
    pub fn rdp8n_3(&mut self) -> Rdp8n3W<OtpRdProt3Spec> {
        Rdp8n3W::new(self, 3)
    }
    #[doc = "Bit 4 - Read Protect Block 8*n+4"]
    #[inline(always)]
    pub fn rdp8n_4(&mut self) -> Rdp8n4W<OtpRdProt3Spec> {
        Rdp8n4W::new(self, 4)
    }
    #[doc = "Bit 5 - Read Protect Block 8*n+5"]
    #[inline(always)]
    pub fn rdp8n_5(&mut self) -> Rdp8n5W<OtpRdProt3Spec> {
        Rdp8n5W::new(self, 5)
    }
    #[doc = "Bit 6 - Read Protect Block 8*n+6"]
    #[inline(always)]
    pub fn rdp8n_6(&mut self) -> Rdp8n6W<OtpRdProt3Spec> {
        Rdp8n6W::new(self, 6)
    }
    #[doc = "Bit 7 - Read Protect Block 8*n+7"]
    #[inline(always)]
    pub fn rdp8n_7(&mut self) -> Rdp8n7W<OtpRdProt3Spec> {
        Rdp8n7W::new(self, 7)
    }
}
#[doc = "OTP Read Protect 0-15 Register (OTP_RD_PROT_0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`otp_rd_prot_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otp_rd_prot_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtpRdProt3Spec;
impl crate::RegisterSpec for OtpRdProt3Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`otp_rd_prot_3::R`](R) reader structure"]
impl crate::Readable for OtpRdProt3Spec {}
#[doc = "`write(|w| ..)` method takes [`otp_rd_prot_3::W`](W) writer structure"]
impl crate::Writable for OtpRdProt3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets OTP_RD_PROT_3 to value 0"]
impl crate::Resettable for OtpRdProt3Spec {
