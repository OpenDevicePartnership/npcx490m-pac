#[doc = "Register `OTP_WR_PROT_11` reader"]
pub type R = crate::R<OtpWrProt11Spec>;
#[doc = "Register `OTP_WR_PROT_11` writer"]
pub type W = crate::W<OtpWrProt11Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_0(&mut self) -> Wrp8n0W<OtpWrProt11Spec> {
        Wrp8n0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write Protect Block 8*n+1"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_1(&mut self) -> Wrp8n1W<OtpWrProt11Spec> {
        Wrp8n1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protect Block 8*n+2"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_2(&mut self) -> Wrp8n2W<OtpWrProt11Spec> {
        Wrp8n2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write Protect Block 8*n+3"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_3(&mut self) -> Wrp8n3W<OtpWrProt11Spec> {
        Wrp8n3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write Protect Block 8*n+4"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_4(&mut self) -> Wrp8n4W<OtpWrProt11Spec> {
        Wrp8n4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write Protect Block 8*n+5"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_5(&mut self) -> Wrp8n5W<OtpWrProt11Spec> {
        Wrp8n5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write Protect Block 8*n+6"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_6(&mut self) -> Wrp8n6W<OtpWrProt11Spec> {
        Wrp8n6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write Protect Block 8*n+7"]
    #[inline(always)]
    #[must_use]
    pub fn wrp8n_7(&mut self) -> Wrp8n7W<OtpWrProt11Spec> {
        Wrp8n7W::new(self, 7)
    }
}
#[doc = "OTP Write Protect 0-15 Register (OTP_WR_PROT_0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`otp_wr_prot_11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otp_wr_prot_11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OtpWrProt11Spec;
impl crate::RegisterSpec for OtpWrProt11Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`otp_wr_prot_11::R`](R) reader structure"]
impl crate::Readable for OtpWrProt11Spec {}
#[doc = "`write(|w| ..)` method takes [`otp_wr_prot_11::W`](W) writer structure"]
impl crate::Writable for OtpWrProt11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets OTP_WR_PROT_11 to value 0"]
impl crate::Resettable for OtpWrProt11Spec {
