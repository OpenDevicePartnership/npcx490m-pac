#[doc = "Register `RAM_WPR_ADR_A8` reader"]
pub type R = crate::R<RamWprAdrA8Spec>;
#[doc = "Register `RAM_WPR_ADR_A8` writer"]
pub type W = crate::W<RamWprAdrA8Spec>;
...
impl W {
    #[doc = "Bit 0 - Write Protect Sector 0"]
    #[inline(always)]
    pub fn wpr_sk0(&mut self) -> WprSk0W<RamWprAdrA8Spec> {
        WprSk0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write Protect Sector 1"]
    #[inline(always)]
    pub fn wpr_sk1(&mut self) -> WprSk1W<RamWprAdrA8Spec> {
        WprSk1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protect Sector 2"]
    #[inline(always)]
    pub fn wpr_sk2(&mut self) -> WprSk2W<RamWprAdrA8Spec> {
        WprSk2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write Protect Sector 3"]
    #[inline(always)]
    pub fn wpr_sk3(&mut self) -> WprSk3W<RamWprAdrA8Spec> {
        WprSk3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write Protect Sector 4"]
    #[inline(always)]
    pub fn wpr_sk4(&mut self) -> WprSk4W<RamWprAdrA8Spec> {
        WprSk4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write Protect Sector 5"]
    #[inline(always)]
    pub fn wpr_sk5(&mut self) -> WprSk5W<RamWprAdrA8Spec> {
        WprSk5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write Protect Sector 6"]
    #[inline(always)]
    pub fn wpr_sk6(&mut self) -> WprSk6W<RamWprAdrA8Spec> {
        WprSk6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write Protect Sector 7"]
    #[inline(always)]
    pub fn wpr_sk7(&mut self) -> WprSk7W<RamWprAdrA8Spec> {
        WprSk7W::new(self, 7)
    }
}
#[doc = "RAM Write Protect Block Base Address nn Register (RAM_WPR_ADR_nn)\n\nYou can [`read`](crate::Reg::read) this register and get [`ram_wpr_adr_a8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram_wpr_adr_a8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RamWprAdrA8Spec;
impl crate::RegisterSpec for RamWprAdrA8Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ram_wpr_adr_a8::R`](R) reader structure"]
impl crate::Readable for RamWprAdrA8Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_wpr_adr_a8::W`](W) writer structure"]
impl crate::Writable for RamWprAdrA8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets RAM_WPR_ADR_A8 to value 0"]
impl crate::Resettable for RamWprAdrA8Spec {
