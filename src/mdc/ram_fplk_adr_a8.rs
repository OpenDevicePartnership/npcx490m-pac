#[doc = "Register `RAM_FPLK_ADR_A8` reader"]
pub type R = crate::R<RamFplkAdrA8Spec>;
#[doc = "Register `RAM_FPLK_ADR_A8` writer"]
pub type W = crate::W<RamFplkAdrA8Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RAM_FPLK_ADR_A8")
...
impl W {
    #[doc = "Bit 0 - Fetch Protect Lock Sector 0"]
    #[inline(always)]
    pub fn fplk_sk0(&mut self) -> FplkSk0W<RamFplkAdrA8Spec> {
        FplkSk0W::new(self, 0)
    }
    #[doc = "Bit 1 - Fetch Protect Lock Sector 1"]
    #[inline(always)]
    pub fn fplk_sk1(&mut self) -> FplkSk1W<RamFplkAdrA8Spec> {
        FplkSk1W::new(self, 1)
    }
    #[doc = "Bit 2 - Fetch Protect Lock Sector 2"]
    #[inline(always)]
    pub fn fplk_sk2(&mut self) -> FplkSk2W<RamFplkAdrA8Spec> {
        FplkSk2W::new(self, 2)
    }
    #[doc = "Bit 3 - Fetch Protect Lock Sector 3"]
    #[inline(always)]
    pub fn fplk_sk3(&mut self) -> FplkSk3W<RamFplkAdrA8Spec> {
        FplkSk3W::new(self, 3)
    }
    #[doc = "Bit 4 - Fetch Protect Lock Sector 4"]
    #[inline(always)]
    pub fn fplk_sk4(&mut self) -> FplkSk4W<RamFplkAdrA8Spec> {
        FplkSk4W::new(self, 4)
    }
    #[doc = "Bit 5 - Fetch Protect Lock Sector 5"]
    #[inline(always)]
    pub fn fplk_sk5(&mut self) -> FplkSk5W<RamFplkAdrA8Spec> {
        FplkSk5W::new(self, 5)
    }
    #[doc = "Bit 6 - Fetch Protect Lock Sector 6"]
    #[inline(always)]
    pub fn fplk_sk6(&mut self) -> FplkSk6W<RamFplkAdrA8Spec> {
        FplkSk6W::new(self, 6)
    }
    #[doc = "Bit 7 - Fetch Protect Lock Sector 7"]
    #[inline(always)]
    pub fn fplk_sk7(&mut self) -> FplkSk7W<RamFplkAdrA8Spec> {
        FplkSk7W::new(self, 7)
    }
}
...
pub struct RamFplkAdrA8Spec;
impl crate::RegisterSpec for RamFplkAdrA8Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ram_fplk_adr_a8::R`](R) reader structure"]
impl crate::Readable for RamFplkAdrA8Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_fplk_adr_a8::W`](W) writer structure"]
impl crate::Writable for RamFplkAdrA8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets RAM_FPLK_ADR_A8 to value 0"]
impl crate::Resettable for RamFplkAdrA8Spec {
