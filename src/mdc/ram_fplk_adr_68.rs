#[doc = "Register `RAM_FPLK_ADR_68` reader"]
pub type R = crate::R<RamFplkAdr68Spec>;
#[doc = "Register `RAM_FPLK_ADR_68` writer"]
pub type W = crate::W<RamFplkAdr68Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RAM_FPLK_ADR_68")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk0(&mut self) -> FplkSk0W<RamFplkAdr68Spec> {
        FplkSk0W::new(self, 0)
    }
    #[doc = "Bit 1 - Fetch Protect Lock Sector 1"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk1(&mut self) -> FplkSk1W<RamFplkAdr68Spec> {
        FplkSk1W::new(self, 1)
    }
    #[doc = "Bit 2 - Fetch Protect Lock Sector 2"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk2(&mut self) -> FplkSk2W<RamFplkAdr68Spec> {
        FplkSk2W::new(self, 2)
    }
    #[doc = "Bit 3 - Fetch Protect Lock Sector 3"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk3(&mut self) -> FplkSk3W<RamFplkAdr68Spec> {
        FplkSk3W::new(self, 3)
    }
    #[doc = "Bit 4 - Fetch Protect Lock Sector 4"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk4(&mut self) -> FplkSk4W<RamFplkAdr68Spec> {
        FplkSk4W::new(self, 4)
    }
    #[doc = "Bit 5 - Fetch Protect Lock Sector 5"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk5(&mut self) -> FplkSk5W<RamFplkAdr68Spec> {
        FplkSk5W::new(self, 5)
    }
    #[doc = "Bit 6 - Fetch Protect Lock Sector 6"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk6(&mut self) -> FplkSk6W<RamFplkAdr68Spec> {
        FplkSk6W::new(self, 6)
    }
    #[doc = "Bit 7 - Fetch Protect Lock Sector 7"]
    #[inline(always)]
    #[must_use]
    pub fn fplk_sk7(&mut self) -> FplkSk7W<RamFplkAdr68Spec> {
        FplkSk7W::new(self, 7)
    }
}
#[doc = "RAM Fetch Protect Lock Block Base Address nn Register (RAM_FPLK_ADR_nn)\n\nYou can [`read`](crate::Reg::read) this register and get [`ram_fplk_adr_68::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram_fplk_adr_68::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RamFplkAdr68Spec;
impl crate::RegisterSpec for RamFplkAdr68Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ram_fplk_adr_68::R`](R) reader structure"]
impl crate::Readable for RamFplkAdr68Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_fplk_adr_68::W`](W) writer structure"]
impl crate::Writable for RamFplkAdr68Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets RAM_FPLK_ADR_68 to value 0"]
impl crate::Resettable for RamFplkAdr68Spec {
