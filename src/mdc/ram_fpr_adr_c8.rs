#[doc = "Register `RAM_FPR_ADR_C8` reader"]
pub type R = crate::R<RamFprAdrC8Spec>;
#[doc = "Register `RAM_FPR_ADR_C8` writer"]
pub type W = crate::W<RamFprAdrC8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk0(&mut self) -> FprSk0W<RamFprAdrC8Spec> {
        FprSk0W::new(self, 0)
    }
    #[doc = "Bit 1 - Fetch Protect Sector 1"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk1(&mut self) -> FprSk1W<RamFprAdrC8Spec> {
        FprSk1W::new(self, 1)
    }
    #[doc = "Bit 2 - Fetch Protect Sector 2"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk2(&mut self) -> FprSk2W<RamFprAdrC8Spec> {
        FprSk2W::new(self, 2)
    }
    #[doc = "Bit 3 - Fetch Protect Sector 3"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk3(&mut self) -> FprSk3W<RamFprAdrC8Spec> {
        FprSk3W::new(self, 3)
    }
    #[doc = "Bit 4 - Fetch Protect Sector 4"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk4(&mut self) -> FprSk4W<RamFprAdrC8Spec> {
        FprSk4W::new(self, 4)
    }
    #[doc = "Bit 5 - Fetch Protect Sector 5"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk5(&mut self) -> FprSk5W<RamFprAdrC8Spec> {
        FprSk5W::new(self, 5)
    }
    #[doc = "Bit 6 - Fetch Protect Sector 6"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk6(&mut self) -> FprSk6W<RamFprAdrC8Spec> {
        FprSk6W::new(self, 6)
    }
    #[doc = "Bit 7 - Fetch Protect Sector 7"]
    #[inline(always)]
    #[must_use]
    pub fn fpr_sk7(&mut self) -> FprSk7W<RamFprAdrC8Spec> {
        FprSk7W::new(self, 7)
    }
}
#[doc = "RAM Fetch Protect Block Base Address nn Register (RAM_FPR_ADR_nn)\n\nYou can [`read`](crate::Reg::read) this register and get [`ram_fpr_adr_c8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram_fpr_adr_c8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RamFprAdrC8Spec;
impl crate::RegisterSpec for RamFprAdrC8Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ram_fpr_adr_c8::R`](R) reader structure"]
impl crate::Readable for RamFprAdrC8Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_fpr_adr_c8::W`](W) writer structure"]
impl crate::Writable for RamFprAdrC8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets RAM_FPR_ADR_C8 to value 0"]
impl crate::Resettable for RamFprAdrC8Spec {
