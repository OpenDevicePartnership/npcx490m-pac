#[doc = "Register `RAM_WPLK_ADR_40` reader"]
pub type R = crate::R<RamWplkAdr40Spec>;
#[doc = "Register `RAM_WPLK_ADR_40` writer"]
pub type W = crate::W<RamWplkAdr40Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RAM_WPLK_ADR_40")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk0(&mut self) -> WplkSk0W<RamWplkAdr40Spec> {
        WplkSk0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write Protect Lock Sector 1"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk1(&mut self) -> WplkSk1W<RamWplkAdr40Spec> {
        WplkSk1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protect Lock Sector 2"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk2(&mut self) -> WplkSk2W<RamWplkAdr40Spec> {
        WplkSk2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write Protect Lock Sector 3"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk3(&mut self) -> WplkSk3W<RamWplkAdr40Spec> {
        WplkSk3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write Protect Lock Sector 4"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk4(&mut self) -> WplkSk4W<RamWplkAdr40Spec> {
        WplkSk4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write Protect Lock Sector 5"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk5(&mut self) -> WplkSk5W<RamWplkAdr40Spec> {
        WplkSk5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write Protect Lock Sector 6"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk6(&mut self) -> WplkSk6W<RamWplkAdr40Spec> {
        WplkSk6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write Protect Lock Sector 7"]
    #[inline(always)]
    #[must_use]
    pub fn wplk_sk7(&mut self) -> WplkSk7W<RamWplkAdr40Spec> {
        WplkSk7W::new(self, 7)
    }
}
#[doc = "RAM Write Protect Lock Block Base Address nn Register (RAM_WPLK_ADR_nn)\n\nYou can [`read`](crate::Reg::read) this register and get [`ram_wplk_adr_40::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram_wplk_adr_40::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RamWplkAdr40Spec;
impl crate::RegisterSpec for RamWplkAdr40Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ram_wplk_adr_40::R`](R) reader structure"]
impl crate::Readable for RamWplkAdr40Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_wplk_adr_40::W`](W) writer structure"]
impl crate::Writable for RamWplkAdr40Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets RAM_WPLK_ADR_40 to value 0"]
impl crate::Resettable for RamWplkAdr40Spec {
