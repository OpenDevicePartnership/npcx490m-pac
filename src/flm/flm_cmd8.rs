#[doc = "Register `FLM_CMD8` reader"]
pub type R = crate::R<FlmCmd8Spec>;
#[doc = "Register `FLM_CMD8` writer"]
pub type W = crate::W<FlmCmd8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd(&mut self) -> CmdW<FlmCmd8Spec> {
        CmdW::new(self, 0)
    }
    #[doc = "Bit 11 - Address Size for Limiting Command"]
    #[inline(always)]
    #[must_use]
    pub fn addsz(&mut self) -> AddszW<FlmCmd8Spec> {
        AddszW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Data Bits Per Clock"]
    #[inline(always)]
    #[must_use]
    pub fn datbpck(&mut self) -> DatbpckW<FlmCmd8Spec> {
        DatbpckW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Address Bits Per Clock"]
    #[inline(always)]
    #[must_use]
    pub fn adbpck(&mut self) -> AdbpckW<FlmCmd8Spec> {
        AdbpckW::new(self, 14)
    }
    #[doc = "Bits 16:17 - Dummy Bits Per Clock"]
    #[inline(always)]
    #[must_use]
    pub fn dumbpck(&mut self) -> DumbpckW<FlmCmd8Spec> {
        DumbpckW::new(self, 16)
    }
    #[doc = "Bits 18:19 - Dummy Bytes"]
    #[inline(always)]
    #[must_use]
    pub fn dumb(&mut self) -> DumbW<FlmCmd8Spec> {
        DumbW::new(self, 18)
    }
    #[doc = "Bit 20 - Command Limited Address Range"]
    #[inline(always)]
    #[must_use]
    pub fn clar(&mut self) -> ClarW<FlmCmd8Spec> {
        ClarW::new(self, 20)
    }
}
#[doc = "FLM Command Register 0-31 (FLM_CMD0-31)\n\nYou can [`read`](crate::Reg::read) this register and get [`flm_cmd8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flm_cmd8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlmCmd8Spec;
impl crate::RegisterSpec for FlmCmd8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flm_cmd8::R`](R) reader structure"]
impl crate::Readable for FlmCmd8Spec {}
#[doc = "`write(|w| ..)` method takes [`flm_cmd8::W`](W) writer structure"]
impl crate::Writable for FlmCmd8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLM_CMD8 to value 0"]
impl crate::Resettable for FlmCmd8Spec {
