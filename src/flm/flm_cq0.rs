#[doc = "Register `FLM_CQ0` reader"]
pub type R = crate::R<FlmCq0Spec>;
#[doc = "Register `FLM_CQ0` writer"]
pub type W = crate::W<FlmCq0Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Qualifier Compare Mask"]
    #[inline(always)]
    pub fn qmask(&mut self) -> QmaskW<FlmCq0Spec> {
        QmaskW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Qualifier Compare Value"]
    #[inline(always)]
    pub fn qval(&mut self) -> QvalW<FlmCq0Spec> {
        QvalW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Qualifier Compare Byte Index"]
    #[inline(always)]
    pub fn qbyte(&mut self) -> QbyteW<FlmCq0Spec> {
        QbyteW::new(self, 16)
    }
    #[doc = "Bit 20 - Qualifier Compare Polarity"]
    #[inline(always)]
    pub fn qpol(&mut self) -> QpolW<FlmCq0Spec> {
        QpolW::new(self, 20)
    }
    #[doc = "Bits 24:31 - Qualifier Enable"]
    #[inline(always)]
    pub fn qen(&mut self) -> QenW<FlmCq0Spec> {
        QenW::new(self, 24)
    }
}
#[doc = "FLM Command Qualifier Register 0-3 (FLM_CQ0-3)\n\nYou can [`read`](crate::Reg::read) this register and get [`flm_cq0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flm_cq0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlmCq0Spec;
impl crate::RegisterSpec for FlmCq0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flm_cq0::R`](R) reader structure"]
impl crate::Readable for FlmCq0Spec {}
#[doc = "`write(|w| ..)` method takes [`flm_cq0::W`](W) writer structure"]
impl crate::Writable for FlmCq0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLM_CQ0 to value 0"]
impl crate::Resettable for FlmCq0Spec {
