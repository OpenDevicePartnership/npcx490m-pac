#[doc = "Register `FLM_CQ0-32` reader"]
pub type R = crate::R<FlmCq032Spec>;
#[doc = "Register `FLM_CQ0-32` writer"]
pub type W = crate::W<FlmCq032Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn qmask(&mut self) -> QmaskW<FlmCq032Spec> {
        QmaskW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Qualifier Compare Value"]
    #[inline(always)]
    #[must_use]
    pub fn qval(&mut self) -> QvalW<FlmCq032Spec> {
        QvalW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Qualifier Compare Byte Index"]
    #[inline(always)]
    #[must_use]
    pub fn qbyte(&mut self) -> QbyteW<FlmCq032Spec> {
        QbyteW::new(self, 16)
    }
    #[doc = "Bit 20 - Qualifier Compare Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn qpol(&mut self) -> QpolW<FlmCq032Spec> {
        QpolW::new(self, 20)
    }
    #[doc = "Bits 24:31 - Qualifier Enable"]
    #[inline(always)]
    #[must_use]
    pub fn qen(&mut self) -> QenW<FlmCq032Spec> {
        QenW::new(self, 24)
    }
}
#[doc = "FLM Command Qualifier Register 0-3 (FLM_CQ0-3)\n\nYou can [`read`](crate::Reg::read) this register and get [`flm_cq032::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flm_cq032::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlmCq032Spec;
impl crate::RegisterSpec for FlmCq032Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flm_cq032::R`](R) reader structure"]
impl crate::Readable for FlmCq032Spec {}
#[doc = "`write(|w| ..)` method takes [`flm_cq032::W`](W) writer structure"]
impl crate::Writable for FlmCq032Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLM_CQ0-32 to value 0"]
impl crate::Resettable for FlmCq032Spec {
