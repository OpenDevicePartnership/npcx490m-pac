#[doc = "Register `THRCTL3` reader"]
pub type R = crate::R<Thrctl3Spec>;
#[doc = "Register `THRCTL3` writer"]
pub type W = crate::W<Thrctl3Spec>;
...
#[doc = "Threshold Control 1-6 Register (THRCTL1-6)\n\nYou can [`read`](crate::Reg::read) this register and get [`thrctl3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`thrctl3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Thrctl3Spec;
impl crate::RegisterSpec for Thrctl3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`thrctl3::R`](R) reader structure"]
impl crate::Readable for Thrctl3Spec {}
#[doc = "`write(|w| ..)` method takes [`thrctl3::W`](W) writer structure"]
impl crate::Writable for Thrctl3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets THRCTL3 to value 0"]
impl crate::Resettable for Thrctl3Spec {
