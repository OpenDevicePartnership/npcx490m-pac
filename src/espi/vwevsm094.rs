#[doc = "Register `VWEVSM0-94` reader"]
pub type R = crate::R<Vwevsm094Spec>;
#[doc = "Register `VWEVSM0-94` writer"]
pub type W = crate::W<Vwevsm094Spec>;
...
#[doc = "Virtual Wire Event Target-to-Controller Register 0-9 (VWEVSM0-9)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwevsm094::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwevsm094::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwevsm094Spec;
impl crate::RegisterSpec for Vwevsm094Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwevsm094::R`](R) reader structure"]
impl crate::Readable for Vwevsm094Spec {}
#[doc = "`write(|w| ..)` method takes [`vwevsm094::W`](W) writer structure"]
impl crate::Writable for Vwevsm094Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWEVSM0-94 to value 0"]
impl crate::Resettable for Vwevsm094Spec {
