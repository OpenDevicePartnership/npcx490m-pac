#[doc = "Register `FLASH_PRTR_BADDR0-1510` reader"]
pub type R = crate::R<FlashPrtrBaddr01510Spec>;
#[doc = "Register `FLASH_PRTR_BADDR0-1510` writer"]
pub type W = crate::W<FlashPrtrBaddr01510Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLASH_PRTR_BADDR0-1510")
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flash_prtr_baddr(&mut self) -> FlashPrtrBaddrW<FlashPrtrBaddr01510Spec> {
        FlashPrtrBaddrW::new(self, 12)
    }
    #[doc = "Bit 29 - Flash Range Write Protect"]
    #[inline(always)]
    #[must_use]
    pub fn frng_wpr(&mut self) -> FrngWprW<FlashPrtrBaddr01510Spec> {
        FrngWprW::new(self, 29)
    }
    #[doc = "Bit 30 - Flash Range Read Protect"]
    #[inline(always)]
    #[must_use]
    pub fn frng_rpr(&mut self) -> FrngRprW<FlashPrtrBaddr01510Spec> {
        FrngRprW::new(self, 30)
    }
    #[doc = "Bit 31 - Target-Attached Flash Protection Lock"]
    #[inline(always)]
    #[must_use]
    pub fn saf_prot_lck(&mut self) -> SafProtLckW<FlashPrtrBaddr01510Spec> {
        SafProtLckW::new(self, 31)
    }
}
#[doc = "Flash Protection Range Base Address Register 0-15 (FLASH_PRTR_BADDR0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`flash_prtr_baddr01510::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_prtr_baddr01510::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashPrtrBaddr01510Spec;
impl crate::RegisterSpec for FlashPrtrBaddr01510Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flash_prtr_baddr01510::R`](R) reader structure"]
impl crate::Readable for FlashPrtrBaddr01510Spec {}
#[doc = "`write(|w| ..)` method takes [`flash_prtr_baddr01510::W`](W) writer structure"]
impl crate::Writable for FlashPrtrBaddr01510Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLASH_PRTR_BADDR0-1510 to value 0"]
impl crate::Resettable for FlashPrtrBaddr01510Spec {
