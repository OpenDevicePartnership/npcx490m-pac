#[doc = "Register `VWGPMS0-1512` reader"]
pub type R = crate::R<Vwgpms01512Spec>;
#[doc = "Register `VWGPMS0-1512` writer"]
pub type W = crate::W<Vwgpms01512Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wire3_0(&mut self) -> Wire3_0W<Vwgpms01512Spec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    #[must_use]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<Vwgpms01512Spec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    #[must_use]
    pub fn index_en(&mut self) -> IndexEnW<Vwgpms01512Spec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Modified"]
    #[inline(always)]
    #[must_use]
    pub fn modified(&mut self) -> ModifiedW<Vwgpms01512Spec> {
        ModifiedW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    #[must_use]
    pub fn enpltrst(&mut self) -> EnpltrstW<Vwgpms01512Spec> {
        EnpltrstW::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IeW<Vwgpms01512Spec> {
        IeW::new(self, 18)
    }
    #[doc = "Bit 19 - Enable eSPI_RST"]
    #[inline(always)]
    #[must_use]
    pub fn enespirst(&mut self) -> EnespirstW<Vwgpms01512Spec> {
        EnespirstW::new(self, 19)
    }
    #[doc = "Bit 20 - Wake-up Enable"]
    #[inline(always)]
    #[must_use]
    pub fn we(&mut self) -> WeW<Vwgpms01512Spec> {
        WeW::new(self, 20)
    }
}
#[doc = "Virtual Wire GPIO Controller-to-Target Register 0-15 (VWGPMS0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwgpms01512::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwgpms01512::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwgpms01512Spec;
impl crate::RegisterSpec for Vwgpms01512Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwgpms01512::R`](R) reader structure"]
impl crate::Readable for Vwgpms01512Spec {}
#[doc = "`write(|w| ..)` method takes [`vwgpms01512::W`](W) writer structure"]
impl crate::Writable for Vwgpms01512Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWGPMS0-1512 to value 0"]
impl crate::Resettable for Vwgpms01512Spec {
