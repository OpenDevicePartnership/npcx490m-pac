#[doc = "Register `VWEVMS0-114` reader"]
pub type R = crate::R<Vwevms0114Spec>;
#[doc = "Register `VWEVMS0-114` writer"]
pub type W = crate::W<Vwevms0114Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Wire 3-0"]
    #[inline(always)]
    pub fn wire3_0(&mut self) -> Wire3_0W<Vwevms0114Spec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<Vwevms0114Spec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bits 8:14 - Index Value"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<Vwevms0114Spec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    pub fn index_en(&mut self) -> IndexEnW<Vwevms0114Spec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Modified"]
    #[inline(always)]
    pub fn modified(&mut self) -> ModifiedW<Vwevms0114Spec> {
        ModifiedW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    pub fn enpltrst(&mut self) -> EnpltrstW<Vwevms0114Spec> {
        EnpltrstW::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt Enable"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<Vwevms0114Spec> {
        IeW::new(self, 18)
    }
    #[doc = "Bit 19 - Enable eSPI_RST"]
    #[inline(always)]
    pub fn enespirst(&mut self) -> EnespirstW<Vwevms0114Spec> {
        EnespirstW::new(self, 19)
    }
    #[doc = "Bit 20 - Wake-up Enable"]
    #[inline(always)]
    pub fn we(&mut self) -> WeW<Vwevms0114Spec> {
        WeW::new(self, 20)
    }
}
#[doc = "Virtual Wire Event Controller-to-Target Register 0-11 (VWEVMS0-11)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwevms0114::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwevms0114::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwevms0114Spec;
impl crate::RegisterSpec for Vwevms0114Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwevms0114::R`](R) reader structure"]
impl crate::Readable for Vwevms0114Spec {}
#[doc = "`write(|w| ..)` method takes [`vwevms0114::W`](W) writer structure"]
impl crate::Writable for Vwevms0114Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWEVMS0-114 to value 0"]
impl crate::Resettable for Vwevms0114Spec {
