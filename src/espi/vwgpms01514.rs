#[doc = "Register `VWGPMS0-1514` reader"]
pub type R = crate::R<Vwgpms01514Spec>;
#[doc = "Register `VWGPMS0-1514` writer"]
pub type W = crate::W<Vwgpms01514Spec>;
...
#[doc = "Virtual Wire GPIO Controller-to-Target Register 0-15 (VWGPMS0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwgpms01514::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwgpms01514::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwgpms01514Spec;
impl crate::RegisterSpec for Vwgpms01514Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwgpms01514::R`](R) reader structure"]
impl crate::Readable for Vwgpms01514Spec {}
#[doc = "`write(|w| ..)` method takes [`vwgpms01514::W`](W) writer structure"]
impl crate::Writable for Vwgpms01514Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWGPMS0-1514 to value 0"]
impl crate::Resettable for Vwgpms01514Spec {
