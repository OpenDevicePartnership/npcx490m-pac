#[doc = "Register `VWEVSM%s` reader"]
pub type R = crate::R<VwevsmSpec>;
#[doc = "Register `VWEVSM%s` writer"]
pub type W = crate::W<VwevsmSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Wire 3-0"]
    #[inline(always)]
    pub fn wire3_0(&mut self) -> Wire3_0W<VwevsmSpec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<VwevsmSpec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bits 8:14 - Index Value"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<VwevsmSpec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    pub fn index_en(&mut self) -> IndexEnW<VwevsmSpec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Dirty"]
    #[inline(always)]
    pub fn dirty(&mut self) -> DirtyW<VwevsmSpec> {
        DirtyW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    pub fn enpltrst(&mut self) -> EnpltrstW<VwevsmSpec> {
        EnpltrstW::new(self, 17)
    }
    #[doc = "Bit 19 - Enable Core Reset"]
    #[inline(always)]
    pub fn encdrst(&mut self) -> EncdrstW<VwevsmSpec> {
        EncdrstW::new(self, 19)
    }
    #[doc = "Bits 20:23 - Polarity of Wire 3-0"]
    #[inline(always)]
    pub fn pol_wire3_0(&mut self) -> PolWire3_0W<VwevsmSpec> {
        PolWire3_0W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Hardware-Controlled Wire 3-0"]
    #[inline(always)]
    pub fn hw_wire3_0(&mut self) -> HwWire3_0W<VwevsmSpec> {
        HwWire3_0W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Edge Type Wire 3-0"]
    #[inline(always)]
    pub fn edge_wire3_0(&mut self) -> EdgeWire3_0W<VwevsmSpec> {
        EdgeWire3_0W::new(self, 28)
    }
}
#[doc = "Virtual Wire Event Target-to-Controller Register 0-9 (VWEVSM0-9)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwevsm::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwevsm::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VwevsmSpec;
impl crate::RegisterSpec for VwevsmSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwevsm::R`](R) reader structure"]
impl crate::Readable for VwevsmSpec {}
#[doc = "`write(|w| ..)` method takes [`vwevsm::W`](W) writer structure"]
impl crate::Writable for VwevsmSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWEVSM%s to value 0"]
impl crate::Resettable for VwevsmSpec {
