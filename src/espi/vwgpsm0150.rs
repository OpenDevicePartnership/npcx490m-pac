#[doc = "Register `VWGPSM0-150` reader"]
pub type R = crate::R<Vwgpsm0150Spec>;
#[doc = "Register `VWGPSM0-150` writer"]
pub type W = crate::W<Vwgpsm0150Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wire3_0(&mut self) -> Wire3_0W<Vwgpsm0150Spec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    #[must_use]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<Vwgpsm0150Spec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    #[must_use]
    pub fn index_en(&mut self) -> IndexEnW<Vwgpsm0150Spec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Dirty"]
    #[inline(always)]
    #[must_use]
    pub fn dirty(&mut self) -> DirtyW<Vwgpsm0150Spec> {
        DirtyW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    #[must_use]
    pub fn enpltrst(&mut self) -> EnpltrstW<Vwgpsm0150Spec> {
        EnpltrstW::new(self, 17)
    }
}
#[doc = "Virtual Wire GPIO Target-to-Controller Register 0-15 (VWGPSM0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwgpsm0150::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwgpsm0150::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwgpsm0150Spec;
impl crate::RegisterSpec for Vwgpsm0150Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwgpsm0150::R`](R) reader structure"]
impl crate::Readable for Vwgpsm0150Spec {}
#[doc = "`write(|w| ..)` method takes [`vwgpsm0150::W`](W) writer structure"]
impl crate::Writable for Vwgpsm0150Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWGPSM0-150 to value 0"]
impl crate::Resettable for Vwgpsm0150Spec {
