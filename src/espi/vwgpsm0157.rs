#[doc = "Register `VWGPSM0-157` reader"]
pub type R = crate::R<Vwgpsm0157Spec>;
#[doc = "Register `VWGPSM0-157` writer"]
pub type W = crate::W<Vwgpsm0157Spec>;
...
#[doc = "Virtual Wire GPIO Target-to-Controller Register 0-15 (VWGPSM0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwgpsm0157::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwgpsm0157::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwgpsm0157Spec;
impl crate::RegisterSpec for Vwgpsm0157Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwgpsm0157::R`](R) reader structure"]
impl crate::Readable for Vwgpsm0157Spec {}
#[doc = "`write(|w| ..)` method takes [`vwgpsm0157::W`](W) writer structure"]
impl crate::Writable for Vwgpsm0157Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWGPSM0-157 to value 0"]
impl crate::Resettable for Vwgpsm0157Spec {
