#[doc = "Register `VWEVSM0-98` reader"]
pub type R = crate::R<Vwevsm098Spec>;
#[doc = "Register `VWEVSM0-98` writer"]
pub type W = crate::W<Vwevsm098Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Wire 3-0"]
    #[inline(always)]
    pub fn wire3_0(&mut self) -> Wire3_0W<Vwevsm098Spec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<Vwevsm098Spec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bits 8:14 - Index Value"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<Vwevsm098Spec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    pub fn index_en(&mut self) -> IndexEnW<Vwevsm098Spec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Dirty"]
    #[inline(always)]
    pub fn dirty(&mut self) -> DirtyW<Vwevsm098Spec> {
        DirtyW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    pub fn enpltrst(&mut self) -> EnpltrstW<Vwevsm098Spec> {
        EnpltrstW::new(self, 17)
    }
    #[doc = "Bit 19 - Enable Core Reset"]
    #[inline(always)]
    pub fn encdrst(&mut self) -> EncdrstW<Vwevsm098Spec> {
        EncdrstW::new(self, 19)
    }
    #[doc = "Bits 20:23 - Polarity of Wire 3-0"]
    #[inline(always)]
    pub fn pol_wire3_0(&mut self) -> PolWire3_0W<Vwevsm098Spec> {
        PolWire3_0W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Hardware-Controlled Wire 3-0"]
    #[inline(always)]
    pub fn hw_wire3_0(&mut self) -> HwWire3_0W<Vwevsm098Spec> {
        HwWire3_0W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Edge Type Wire 3-0"]
    #[inline(always)]
    pub fn edge_wire3_0(&mut self) -> EdgeWire3_0W<Vwevsm098Spec> {
        EdgeWire3_0W::new(self, 28)
    }
}
#[doc = "Virtual Wire Event Target-to-Controller Register 0-9 (VWEVSM0-9)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwevsm098::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwevsm098::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwevsm098Spec;
impl crate::RegisterSpec for Vwevsm098Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwevsm098::R`](R) reader structure"]
impl crate::Readable for Vwevsm098Spec {}
#[doc = "`write(|w| ..)` method takes [`vwevsm098::W`](W) writer structure"]
impl crate::Writable for Vwevsm098Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWEVSM0-98 to value 0"]
impl crate::Resettable for Vwevsm098Spec {
