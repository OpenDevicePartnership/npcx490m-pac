#[doc = "Register `VWGPMS0-1513` reader"]
pub type R = crate::R<Vwgpms01513Spec>;
#[doc = "Register `VWGPMS0-1513` writer"]
pub type W = crate::W<Vwgpms01513Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Wire 3-0"]
    #[inline(always)]
    pub fn wire3_0(&mut self) -> Wire3_0W<Vwgpms01513Spec> {
        Wire3_0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Wire 3-0 Valid"]
    #[inline(always)]
    pub fn wire3_0valid(&mut self) -> Wire3_0validW<Vwgpms01513Spec> {
        Wire3_0validW::new(self, 4)
    }
    #[doc = "Bit 15 - Index Enable"]
    #[inline(always)]
    pub fn index_en(&mut self) -> IndexEnW<Vwgpms01513Spec> {
        IndexEnW::new(self, 15)
    }
    #[doc = "Bit 16 - Modified"]
    #[inline(always)]
    pub fn modified(&mut self) -> ModifiedW<Vwgpms01513Spec> {
        ModifiedW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PLTRST"]
    #[inline(always)]
    pub fn enpltrst(&mut self) -> EnpltrstW<Vwgpms01513Spec> {
        EnpltrstW::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt Enable"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<Vwgpms01513Spec> {
        IeW::new(self, 18)
    }
    #[doc = "Bit 19 - Enable eSPI_RST"]
    #[inline(always)]
    pub fn enespirst(&mut self) -> EnespirstW<Vwgpms01513Spec> {
        EnespirstW::new(self, 19)
    }
    #[doc = "Bit 20 - Wake-up Enable"]
    #[inline(always)]
    pub fn we(&mut self) -> WeW<Vwgpms01513Spec> {
        WeW::new(self, 20)
    }
}
#[doc = "Virtual Wire GPIO Controller-to-Target Register 0-15 (VWGPMS0-15)\n\nYou can [`read`](crate::Reg::read) this register and get [`vwgpms01513::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vwgpms01513::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Vwgpms01513Spec;
impl crate::RegisterSpec for Vwgpms01513Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vwgpms01513::R`](R) reader structure"]
impl crate::Readable for Vwgpms01513Spec {}
#[doc = "`write(|w| ..)` method takes [`vwgpms01513::W`](W) writer structure"]
impl crate::Writable for Vwgpms01513Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VWGPMS0-1513 to value 0"]
impl crate::Resettable for Vwgpms01513Spec {
