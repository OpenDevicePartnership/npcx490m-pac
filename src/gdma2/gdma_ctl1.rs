#[doc = "Register `GDMA_CTL1` reader"]
pub type R = crate::R<GdmaCtl1Spec>;
#[doc = "Register `GDMA_CTL1` writer"]
pub type W = crate::W<GdmaCtl1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gdmaen(&mut self) -> GdmaenW<GdmaCtl1Spec> {
        GdmaenW::new(self, 0)
    }
    #[doc = "Bit 1 - GDMA Power-Down"]
    #[inline(always)]
    #[must_use]
    pub fn gpd(&mut self) -> GpdW<GdmaCtl1Spec> {
        GpdW::new(self, 1)
    }
    #[doc = "Bits 2:3 - GDMA Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn gdmams(&mut self) -> GdmamsW<GdmaCtl1Spec> {
        GdmamsW::new(self, 2)
    }
    #[doc = "Bit 4 - Destination Address Direction"]
    #[inline(always)]
    #[must_use]
    pub fn dadir(&mut self) -> DadirW<GdmaCtl1Spec> {
        DadirW::new(self, 4)
    }
    #[doc = "Bit 5 - Source Address Direction"]
    #[inline(always)]
    #[must_use]
    pub fn sadir(&mut self) -> SadirW<GdmaCtl1Spec> {
        SadirW::new(self, 5)
    }
    #[doc = "Bit 6 - Destination Address Fixed"]
    #[inline(always)]
    #[must_use]
    pub fn dafix(&mut self) -> DafixW<GdmaCtl1Spec> {
        DafixW::new(self, 6)
    }
    #[doc = "Bit 7 - Source Address Fixed"]
    #[inline(always)]
    #[must_use]
    pub fn safix(&mut self) -> SafixW<GdmaCtl1Spec> {
        SafixW::new(self, 7)
    }
    #[doc = "Bit 8 - Stop Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sien(&mut self) -> SienW<GdmaCtl1Spec> {
        SienW::new(self, 8)
    }
    #[doc = "Bit 9 - Burst Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bme(&mut self) -> BmeW<GdmaCtl1Spec> {
        BmeW::new(self, 9)
    }
    #[doc = "Bits 12:13 - Transfer Width Select"]
    #[inline(always)]
    #[must_use]
    pub fn tws(&mut self) -> TwsW<GdmaCtl1Spec> {
        TwsW::new(self, 12)
    }
    #[doc = "Bit 14 - GDMA Power Save"]
    #[inline(always)]
    #[must_use]
    pub fn gps(&mut self) -> GpsW<GdmaCtl1Spec> {
        GpsW::new(self, 14)
    }
    #[doc = "Bit 15 - Demand Mode"]
    #[inline(always)]
    #[must_use]
    pub fn dm(&mut self) -> DmW<GdmaCtl1Spec> {
        DmW::new(self, 15)
    }
    #[doc = "Bit 16 - Software Triggered GDMA Request"]
    #[inline(always)]
    #[must_use]
    pub fn softreq(&mut self) -> SoftreqW<GdmaCtl1Spec> {
        SoftreqW::new(self, 16)
    }
    #[doc = "Bit 18 - Terminal Count"]
    #[inline(always)]
    #[must_use]
    pub fn tc(&mut self) -> TcW<GdmaCtl1Spec> {
        TcW::new(self, 18)
    }
    #[doc = "Bit 30 - Burst Mode Destination Address Fixed"]
    #[inline(always)]
    #[must_use]
    pub fn bmdafix(&mut self) -> BmdafixW<GdmaCtl1Spec> {
        BmdafixW::new(self, 30)
    }
    #[doc = "Bit 31 - Burst Mode Source Address Fixed"]
    #[inline(always)]
    #[must_use]
    pub fn bmsafix(&mut self) -> BmsafixW<GdmaCtl1Spec> {
        BmsafixW::new(self, 31)
    }
}
#[doc = "Channel 0/1 Control Register (GDMAn_CTL0, GDMAn_CTL1)\n\nYou can [`read`](crate::Reg::read) this register and get [`gdma_ctl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gdma_ctl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GdmaCtl1Spec;
impl crate::RegisterSpec for GdmaCtl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gdma_ctl1::R`](R) reader structure"]
impl crate::Readable for GdmaCtl1Spec {}
#[doc = "`write(|w| ..)` method takes [`gdma_ctl1::W`](W) writer structure"]
impl crate::Writable for GdmaCtl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GDMA_CTL1 to value 0"]
impl crate::Resettable for GdmaCtl1Spec {
