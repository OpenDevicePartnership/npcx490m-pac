...
#[doc = "Register `MINTMASKED` writer"]
pub type W = crate::W<MintmaskedSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tgtstart(&mut self) -> TgtstartW<MintmaskedSpec> {
        TgtstartW::new(self, 8)
    }
    #[doc = "Bit 9 - MCTRL Done"]
    #[inline(always)]
    #[must_use]
    pub fn mctrldone(&mut self) -> MctrldoneW<MintmaskedSpec> {
        MctrldoneW::new(self, 9)
    }
    #[doc = "Bit 10 - Message Completed"]
    #[inline(always)]
    #[must_use]
    pub fn complete(&mut self) -> CompleteW<MintmaskedSpec> {
        CompleteW::new(self, 10)
    }
    #[doc = "Bit 11 - Receive Buffer Pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxpend(&mut self) -> RxpendW<MintmaskedSpec> {
        RxpendW::new(self, 11)
    }
    #[doc = "Bit 12 - Transmit Buffer Not Full"]
    #[inline(always)]
    #[must_use]
    pub fn txnotfull(&mut self) -> TxnotfullW<MintmaskedSpec> {
        TxnotfullW::new(self, 12)
    }
    #[doc = "Bit 13 - IBI Arbitration Won"]
    #[inline(always)]
    #[must_use]
    pub fn ibiwon(&mut self) -> IbiwonW<MintmaskedSpec> {
        IbiwonW::new(self, 13)
    }
    #[doc = "Bit 15 - Error/Warning"]
    #[inline(always)]
    #[must_use]
    pub fn errwarn(&mut self) -> ErrwarnW<MintmaskedSpec> {
        ErrwarnW::new(self, 15)
    }
    #[doc = "Bit 19 - I3CI Now Bus Controller"]
    #[inline(always)]
    #[must_use]
    pub fn nowcntlr(&mut self) -> NowcntlrW<MintmaskedSpec> {
        NowcntlrW::new(self, 19)
    }
}
#[doc = "Controller Interrupt Masked Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mintmasked::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mintmasked::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`mintmasked::W`](W) writer structure"]
impl crate::Writable for MintmaskedSpec {
